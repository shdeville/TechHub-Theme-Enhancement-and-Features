...
if (window.location.href === 'https://tamu.mybigcommerce.com/') {
    let intervalId = null;
    let isHovered = false;
    ...
    function setupHoverListeners() {
        const carouselContainer = document.querySelector('div[data-widget-id="5859ca70-1656-4246-bf48-68cbbc762662"]');
